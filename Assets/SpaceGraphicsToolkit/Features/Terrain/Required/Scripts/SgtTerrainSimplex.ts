...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtTerrainSimplex : MonoBehaviour, SgtTerrain.IModifiesHeights, SgtTerrain.IModifiesCombinedHeights
	{
		...
		public double Frequency { set { frequency = value; MarkAsDirty(); } get { return frequency; } }
		[SerializeField] private double frequency = 1000.0;
		...
		public double Amplitude { set { amplitude = value; MarkAsDirty(); } get { return amplitude; } }
		[SerializeField] private double amplitude = 100.0;

		/// <summary>Use ridged simplex noise?</summary>
		public bool Ridged { set { ridged = value; MarkAsDirty(); } get { return ridged; } }
		[SerializeField] private bool ridged;

		/// <summary>The random noise seed.</summary>
		public int Seed { set { seed = value; MarkAsDirty(); } get { return seed; } }
		[SerializeField] [CwSeed] private int seed;

		/// <summary>The amount of noise layers.</summary>
		public int Octaves { set { octaves = value; MarkAsDirty(); } get { return octaves; } }
		[SerializeField] [Range(1, 20)] private int octaves = 8;
